...
export const ReportsPage: React.FC = () => {
  ...
  const [filteredSchedules, setFilteredSchedules] = useState<ScheduleReport[]>(mockSchedulesData);
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ 
                ...
                Visualize e exporte o status das escalas dos voluntários
              </p>
            </div>
